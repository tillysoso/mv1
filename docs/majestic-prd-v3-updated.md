...
| Reading Screen, Card Animation & Aura Spec v1.0 | Reading screen layout, card animation choreography, aura glow rules |
...
- Reflection Mode — altar perspective animation, meditative prompts, ambient audio layer (v2)
...
*Majestic — PRD v3.2 — Working Document*
